...
def installSVN(revisions, configFile, whether_installs, bugIds):
    ...
    for i in range(len(revisions)):
        ...
        try:
            ...
            os.system("cd /data/compilers/llvms/llvm; git checkout 5d042c63741bc5ccec8ad18bfebf9f621fcde640; cd ..")
            os.system('rm -rf ' + revpath + '/' + rev)
            os.system('mv llvm ' + revpath + '/' + rev)
            print('downloading clang ... ')
            print("checkout to the faulty version")
            os.system("cd /data/compilers/llvms; git checkout 5d042c63741bc5ccec8ad18bfebf9f621fcde640; cd ..")
