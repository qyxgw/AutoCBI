...
for gcc_revision in gcc_revisions:
    r = gcc_revision.split(",")[0]
    r1 = gcc_revision.split(",")[2]
    r2 = gcc_revision.split(",")[3]
    print(r+':'+r1+' is the optimization level that would not trigger the bug, '+r2+' is the optimization level that would trigger the bug.')