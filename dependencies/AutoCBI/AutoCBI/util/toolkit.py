...
def diffWithExistingPass(passtestdir, failtestdir):
    if os.path.exists('difffilefail'):
        os.system('rm difffilefail')
    if os.path.exists(failtestdir + '/fail.c'):
        os.system('diff mainvar.c ' + failtestdir + '/fail.c' + ' >difffilefail')
    else:
        os.system('diff mainvar.c ' + failtestdir + 'ori' + '/fail.c' + ' >difffilefail')
    difffail = open('difffilefail', 'r')
    ...
    for f in os.listdir(passtestdir):
        if os.path.exists('difffile'):
            os.system('rm difffile')
        os.system('diff mainvar.c ' + passtestdir + '/' + f + ' >difffile')
        difff = open('difffile')
